 ...
 */
static int ima_add_digest_entry(struct ima_namespace *ns, struct ima_template_entry *entry,
				bool update_htable)
{
...
int ima_restore_measurement_entry(struct ima_namespace *ns, struct ima_template_entry *entry)
{
	int result = 0;
